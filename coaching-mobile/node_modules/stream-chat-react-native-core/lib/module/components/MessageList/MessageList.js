...
var MessageListWithContext = function MessageListWithContext(props) {
  ...
  var renderItem = (0, _react.useCallback)(function (_ref6) {
    var _message$user, _message$user2, _messageGroupStylesRe;
    ...
    var isMyMessage = ((_message$user = message.user) == null ? void 0 : _message$user.id) === client.userID;
    var showUnreadSeparator = isLastReadMessage && !isNewestMessage && !isMyMessage && (!!(channelUnreadState != null && channelUnreadState.first_unread_message_id) || !!(channelUnreadState != null && channelUnreadState.unread_messages));
    var showUnreadUnderlay = !!shouldShowUnreadUnderlay && showUnreadSeparator;
    var wrapMessageInTheme = client.userID === ((_message$user2 = message.user) == null ? void 0 : _message$user2.id) && !!myMessageTheme;
